...
| [Virtual Machine Platforms](https://docs.oracle.com/en/industries/communications/session-border-controller/10.1.0/installation/virtual-machines-platforms.html) | Deployed the SBC on KVM, VMware, and OpenStack. |
| [Public Cloud Platforms](https://docs.oracle.com/en/industries/communications/session-border-controller/10.1.0/installation/public-cloud-platforms.html) | Deployed the SBC on [AWS](https://docs.oracle.com/en/industries/communications/session-border-controller/10.1.0/installation/create-deploy-aws.html), [Azure](https://docs.oracle.com/en/industries/communications/session-border-controller/10.1.0/installation/create-deploy-azure.html), [Google Cloud Platform](https://docs.oracle.com/en/industries/communications/session-border-controller/10.1.0/installation/create-deploy-google-cloud-platform.html), and [OCI](https://docs.oracle.com/en/industries/communications/session-border-controller/10.1.0/installation/create-deploy-oci.html). |
